...
signed main()
{
    ...
    // this problem gets converted to a nim game where say at index = 3 we have 2 then it's the same as having 2 piles of size 3 and because this size is even hence, we can say that the contribution in the nim game by this index will be zero because xor of a number with itself even no. of times is 0.
